...
<body>
    <img class="bg" src="18.jpg" alt="CIME BBSR">
    <div class="container">
        <h1>Welcome to CIME BBSR Konark Trip Form</h1>
        <p>Enter your details and submit thi form to conform your
            participation in the trip.</p>
        <?php
        if ($insert == true)
            echo "<p class='submitmsg'>Thanks for Submiting your form.We are happy to see you joining for the conark trip.</p>";
        ?>
